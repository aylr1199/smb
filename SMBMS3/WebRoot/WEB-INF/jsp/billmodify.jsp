          ...
          <form id="billForm" name="billForm" method="post" action="${pageContext.request.contextPath }/sys/bill/modifysave.html">
                ...
                <div>
                    ...
                    <c:if test="${bill.isPayment == 1 }">
						<input type="radio" name="isPayment" value="1" checked="checked">未缴费
						<input type="radio" name="isPayment" value="2" >已缴费
					</c:if>
					<c:if test="${bill.isPayment == 2 }">
						<input type="radio" name="isPayment" value="1">未缴费
						<input type="radio" name="isPayment" value="2" checked="checked">已缴费
					</c:if>
                </div>
